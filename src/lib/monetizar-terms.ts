 ...
 */
export const MONETIZAR_TERMS_VERSION = "2026-08-v6";
...
export const MONETIZAR_TERMS: TermsSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Ese 30% es el piso, no el techo: el porcentaje exacto lo define cada campaña, así que puede ser mayor y puede cambiar de una campaña a otra. Lo único que garantizamos es que nunca baja del 30%.",
  ...
  },
  {
    ...
    body: [
      "¿Conocés un negocio al que le sirva mostrarse en tus torneos? Presentanoslo y, si termina pautando, te pagamos una comisión de al menos el 15% de todo lo que ese anunciante pague durante sus primeros 6 meses, contados desde su primera campaña.",
