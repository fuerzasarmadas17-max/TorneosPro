...
## 12. Las otras puertas de Michigan

**Búsqueda del 2026-08-26.** Todo lo de esta sección sale de los sitios
públicos de cada asociación, mirados ese día. Lo que no encontré, lo digo. No
hablé con nadie todavía.

Antes de escribirle a diez estados por correo frío, conviene mirar el propio
Michigan. Si el producto no convence a la asociación que juega en el mismo
gimnasio que MACS, no lo va a convencer Carolina del Norte a 1.200 kilómetros.

---

### El hallazgo: MACS no está sola en Flint

**MCSAA — Michigan Christian Schools Athletic Association** (`mcsaa.com`) corre
postemporada para escuelas cristianas de Michigan. Su final de básquet es el
**21 de febrero, en el Ballenger Field House de Mott Community College, Flint.**

La final de MACS es el **27 de febrero, en ese mismo edificio.**

Seis días de diferencia, la misma cancha, el mismo estado y el mismo mundo de
iglesias: MCSAA opera desde Bridgeport Baptist Academy y Rochester Hills Baptist
Church, y MACS es la filial bautista de AACS en Michigan.

Eso significa una de dos cosas, y **hay que averiguar cuál antes de escribirle a
MCSAA**:

| Si resulta que… | Lo que implica |
|---|---|
| **Son el mismo circuito** — las escuelas se repiten | Rierson te presenta y entrás por la puerta de adelante. Pero no son dos clientes de $4.500: es un cliente y medio, porque le estarías vendiendo dos veces a los mismos colegios. |
| **Son rivales por las mismas escuelas** | Nombrarle una a la otra te quema con las dos. Son dos ventas separadas, y calladas. |

**Cómo se averigua:** pidiéndole a cada una su lista de escuelas miembro y
cruzándolas. Ninguna de las dos la publica.

Y un detalle que solo, ya justifica haber mirado. El calendario de MCSAA dice,
textual:

> **Seed Meeting: February 3rd**

Una reunión, con fecha propia en el calendario oficial, para sembrar el cuadro a
mano. Es exactamente el trabajo que el producto elimina — y acá no hay que
deducirlo de un manual como con MACS: está publicado.
...
|---|---|
| **Sitio** | `mcsaa.com` |
| **Contacto** | `Info@mcsaa.com` · 989.777.6811 |
| **Sede** | Bridgeport Baptist Academy · Rochester Hills Baptist Church |
| **Directores atléticos** | Paula Brosing, Stephen Lund, Daniel Galdamez, Lou DiAntonio — **son cuatro, no uno.** No hay correos individuales publicados |
| **Deportes** | Otoño: fútbol masculino, voleibol femenino · Invierno: básquet masculino y femenino · Primavera: béisbol, fútbol femenino, golf · Lucha todo el año |
| **Calendario de básquet** | Siembra 3 feb · Cuartos 14 feb (en casa del mejor sembrado) · Semis 17 feb en Lake Orion Baptist Church · Final 21 feb en Mott, Flint |
| **Escuelas miembro** | **No publicado** — mismo hueco que MACS |
| **Software** | No mencionan MaxPreps ni ningún sistema. El reglamento vive en un PDF en Google Drive |

Que sean **cuatro** directores atléticos cambia el correo: no hay un Rierson que
decida solo. Hay que escribirle a `Info@` y pedir que lo pasen a quien coordina
los torneos, o entrar por uno de los cuatro y que él lo lleve adentro.

---

### Las otras cuatro de Michigan

| Asociación | Qué es | Tamaño | Encaje |
|---|---|---|---|
| **CHSL** — Catholic High School League, Detroit · `chsl.com` · 12 State Street, Detroit · 313-237-5960 | La liga católica del área de Detroit. Corre sus propios campeonatos, 20 deportes (16 femeninos, 14 masculinos), divisiones por deporte | ~38 escuelas | **La más grande y la venta más difícil.** Tienen oficina, dirección en el centro de Detroit y presupuesto: ya deben tener sistemas, y el que compra no es un coach voluntario sino una organización. Otra conversación, y otro precio |
| **MHSSA** — Michigan Home School Sports Association · `mhssa.org` | Coordina el deporte de los educados en casa. Básquet es el fuerte. Existe para dar elegibilidad pareja entre programas | Más de 30 programas | **El dolor está a la vista: el calendario lo llevan en una hoja de Google.** Pero no hay una asociación con caja que firme un contrato — son 30 programas sueltos. Barato de servir, difícil de cobrar |
| **GRACEAC** — Grand Rapids Area Catholic Elementary Athletic Council | Liga de primaria y secundaria baja de las escuelas católicas de Grand Rapids | Diócesis de Grand Rapids | ⚠️ **Es toda de menores de 13.** Acá el problema de COPPA de la sección 4 de `proyeccion-y-estructura-eeuu.md` no es un riesgo lateral: es el producto entero. Su presencia pública es una página de Facebook |
| **MIAC** — Michigan Independent Athletic Conference | Conferencia de colegios privados **dentro** de la MHSAA (ahí juega Southfield Christian, por ejemplo) | Chica | **Descartada.** La postemporada se la corre la MHSAA, que es el organismo estatal. No tienen el problema que resuelve el producto |

También miré la **Lutheran High School Association of Greater Detroit**: son tres
colegios y juegan en la MHSAA. Demasiado chica.

---

### En qué orden escribirles

1. **MCSAA** — primero, pero **después** de cruzar su lista de escuelas con la de
   MACS. Es la más parecida a MACS que vas a encontrar en todo el país, y está a
   media hora en carro.
2. **MHSSA** — la hoja de Google es la mejor entrada en frío de las cinco. Sirve
   sobre todo como campo de pruebas: si funciona ahí, funciona.
3. **CHSL** — no en frío. Vale la pena solo con un cliente andando que los
   respalde.
4. **GRACEAC** — no hasta tener resuelto lo de los menores de 13.
5. **MIAC** — no.

---

### Lo que esto le cambia a la lista de los diez estados

Dos cosas, y las dos ahorran trabajo:

**Michigan tiene por lo menos dos asociaciones cristianas que corren
postemporada, no una.** Si eso se repite en los otros estados, el mercado no son
las 38 filiales de AACS de la sección 6: es bastante más grande. Pero también
quiere decir que **la lista de AACS no alcanza para encontrarlas** — MCSAA no
está en esa lista y es la más parecida a MACS que hay.

**Y el filtro para los diez estados ya está probado acá:** que corran
postemporada propia (no que solo acrediten), que publiquen un calendario con
fecha de siembra, y que no haya un organismo estatal haciéndoles el trabajo.
De los cinco de Michigan, ese filtro deja dos.
...
- MCSAA, Michigan Christian Schools Athletic Association — `https://mcsaa.com/`
- MCSAA, calendario y sedes de la postemporada —
  `https://mcsaa.com/tournamentinfo`
- MCSAA, contacto — `https://mcsaa.com/contact`
- CHSL, Catholic High School League de Detroit — `https://chsl.com`
- MHSSA, Michigan Home School Sports Association — `https://www.mhssa.org/`
