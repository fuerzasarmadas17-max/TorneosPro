...
**1. Migración SQL** — escrita como `supabase/migrations/aplicadas/20260731_tournament_featured.sql`. La escribo yo, la corre el organizador en el panel de Supabase, y recién después se despliega el código.
