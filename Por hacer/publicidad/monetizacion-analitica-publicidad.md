...
| Archivo | Qué hace |
|---|---|
| `supabase/migrations/aplicadas/20260808_my_ad_earnings.sql` | RPC `get_my_ad_earnings`, **solo service_role** |
| `supabase/migrations/aplicadas/20260808b_monetizar_terms.sql` | `terms_version` + `terms_accepted_at` en `organizer_payout_info`, con trigger que sella la fecha del servidor |
