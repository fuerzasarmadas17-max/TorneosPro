...
Las pantallas están dibujadas en `Por hacer/deportes/voley/planilla-volley-propuestas/`:
...
el 2026-09-06, en `Por hacer/deportes/voley/planilla-volley-propuestas/` (los `.png` son las
...
ABRIR el link no anda. **Quedó como objetivo pendiente el 2026-09-16**, a pedido
del dueño, con las advertencias de abajo.

### 8.1 Pendiente: abrir la planilla sin señal
...
**Mientras tanto** la planilla ya se probó en uso real (el dueño, antes y
después del cambio de aplazados, 2026-09-16) con el link abierto con señal
antes del partido.
